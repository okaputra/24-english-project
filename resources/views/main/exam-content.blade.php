...
<div class="container-fluid page-header py-6 my-6 mt-0 wow">
    <div class="container text-center">
        <h1 class="display-4 text-white animated slideInDown mb-4">FINAL EXAM</h1>
            ...
            <div class="col-lg-8 wow">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-text">Question &emsp;&emsp;&emsp;&emsp;&nbsp;: <i class="bi bi-book"></i> {{$jumlah_soal_exam}}</p>
                                <p class="card-text">Duration &emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;: <i class="bi bi-clock"></i> {{$exam['durasi']}} Minutes</p>
                                @if($isUserAttemptExam)
                                    <a href="/user-get-result-exam/{{$exam['id']}}/{{$exam['id_sub_course']}}" class="btn btn-primary">RESULT</a>
                                @else
                                    <a href="/user-attempt-exam/{{$exam['id']}}/{{$exam['id_sub_course']}}" class="btn btn-primary attempt"><i class="bi bi-pencil"></i> Attempt Exam</a>
                                @endif
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        Swal.fire({
            title: 'Final Exam Segera Dimulai!',
